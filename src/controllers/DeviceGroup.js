...
module.exports = class DeviceGroupController {
	constructor (app) {
		...
		app.put('/devices/:udid([\\da-fA-F]{16})/groups/:id([\\da-z\\-]+)', auth(), this.onUpdate.bind(this))
		app.delete('/devices/:udid([\\da-fA-F]{16})/groups/:id([\\da-z\\-]+)', auth(), this.onRemove.bind(this))
	}
